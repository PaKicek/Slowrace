...
- `float` - число с плавающей точкой (значимый тип, занимает в памяти 8 байт, состоит из знака, экспоненты и мантиссы). Разделитель - точка. По умолчанию инициализируется значением `0` (все биты равны 0).
...
Можно создавать массивы, содержащие структуры.
